...
class SliderComponent extends HTMLElement {
  constructor() {
    ...
    // Add click handlers
    this.querySelector(".slider__arrow--back")?.addEventListener("click", () =>
      this.navigate("backward")
    );
    this.querySelector(".slider__arrow--forward")?.addEventListener(
      "click",
  ...
  getNewScrollPosition = (arg) => {
    const gap = +window
        .getComputedStyle(this.slider_container)
    ...
    if (arg === "forward") {
      ...
      return x > max_scroll_left
        ? max_scroll_left - scroll_left < 5
          ? 0
          : max_scroll_left
        : x;
